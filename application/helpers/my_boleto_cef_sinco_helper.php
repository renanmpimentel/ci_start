...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_cef_sinco')) {
		/**
		 * Boleto CEF SINCO
		 ...
		 */
		function boleto_cef_sinco($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			require "include/layout_cef_sinco.php";
		}
	}
?>
