...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_hsbc')) {
		/**
		 * Boleto HSBC
		 ...
		 */
		function boleto_hsbc($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			// NÃO ALTERAR!
			require "include/funcoes_hsbc.php"; 
			require "include/layout_hsbc.php";
		}
	}
