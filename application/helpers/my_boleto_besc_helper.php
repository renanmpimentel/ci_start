...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_besc')) {
		/**
		 * Boleto Banco do Besc
		 ...
		 */
		function boleto_besc($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			// NÃO ALTERAR!
			require "include/funcoes_besc.php"; 
			require "include/layout_besc.php";
		}
	}
