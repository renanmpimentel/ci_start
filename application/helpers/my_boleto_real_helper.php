...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_real')) {
		/**
		 * Boleto Real
		 ...
		 */
		function boleto_real($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			require "include/layout_real.php";
		}
	}
?>
