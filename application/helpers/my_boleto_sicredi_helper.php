...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_sicredi')) {
		/**
		 * Boleto Santander Sicredi
		 ...
		 */
		function boleto_sicredi($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			require "include/layout_sicredi.php";
		}
	}
