...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_unibanco')) {
		 ...
		 */
		function boleto_unibanco($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			// NÃO ALTERAR!
			require "include/funcoes_unibanco.php"; 
			require "include/layout_unibanco.php";
		}
	}
?>
