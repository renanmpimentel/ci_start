...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_itau')) {
		/**
		 * Boleto Itau
		 ...
		 */
		function boleto_itau($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			// NÃO ALTERAR!
			require "include/funcoes_itau.php"; 
			require "include/layout_itau.php";
		}
	}
