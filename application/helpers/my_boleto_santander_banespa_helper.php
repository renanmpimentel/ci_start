...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_santander_banespa')) {
		/**
		 * Boleto Santander Banespa
		 ...
		 */
		function boleto_santander_banespa($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			require "include/layout_santander_banespa.php";
		}
	}
?>
