...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_banestes')) {
		/**
		 * Boleto Banestes
		 ...
		 */
		function boleto_banestes($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			// NÃO ALTERAR!
			require "include/funcoes_banestes.php"; 
			require "include/layout_banestes.php";
		}
	}
?>
