...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_sudameris')) {
		 ...
		 */
		function boleto_sudameris($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			*/
			...
			// NÃO ALTERAR!
			require "include/funcoes_sudameris.php";
			require "include/layout_sudameris.php";
		}
	}
?>
